...
* **Nombre:** Magikarp Ground Mission.
* **Link del reto** [link](https://play.picoctf.org/playlists/14?m=101).
...
* **Enunciado:** ¿Sabes cómo navegar entre directorios y leer archivos en el shell? Inicia el contenedor, conéctate por SSH y, una vez conectado, usa el comando ls para comenzar.
Encontrarás más detalles después de iniciar tu instancia de desafío.
