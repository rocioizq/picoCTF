...
- Uso de herramientas básicas (nmap, netcat, Wireshark, etc.)  
- Lectura y análisis de pistas  
- Búsqueda de información y resolución de problemas generales  

---

## **Cómo Documentaré Cada Desafío**

Para cada desafío incluiré:  

1. **Nombre del desafío** – identificación clara del problema.  
2. **Descripción breve** – de qué trata el desafío.  
3. **Pasos y metodología** – cómo abordé el desafío.  
4. **Herramientas y comandos usados** – fragmentos de código o capturas si aplica.  
5. **Aprendizajes clave** – qué habilidades o conceptos reforcé.  

---

## **Objetivo de esta categoría**
